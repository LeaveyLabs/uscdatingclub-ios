...
//        keyboardManager.bind(to: messagesTableView) //enables interactive dismissal
...
//        let collectionViewHeight = messagesTableView.frame.height
...
//            messagesTableView.contentInset.bottom = normalizedNewBottomInset
//            messagesTableView.verticalScrollIndicatorInsets.bottom = newBottomInset
//        }
//    }
//
...
//        
//        let bottom: NSIndexPath = IndexPath(row: tableView(messagesTableView, numberOfRowsInSection: 0) - 1, section: 0) as NSIndexPath
//        messagesTableView.scrollToRow(at: bottom as IndexPath, at: .bottom, animated: true)
//        
...
//        return messagesTableView.adjustedContentInset.bottom - messageCollectionViewBottomInset
//    }
//
//    private var messageCollectionViewBottomInset: CGFloat {
//        return messagesTableView.contentInset.bottom
//    }
//
//    /// UIScrollView can automatically add safe area insets to its contentInset,
//    /// which needs to be accounted for when setting the contentInset based on screen coordinates.
...
//        return messagesTableView.adjustedContentInset.top - messageCollectionViewTopInset
//    }
//
//    private var messageCollectionViewTopInset: CGFloat {
//        return messagesTableView.contentInset.top
//    }
//}
